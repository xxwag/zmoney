...
class WelcomeScreenState extends State<WelcomeScreen>
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          Positioned(
            top: 35, // Adjust as needed for Language Selector
            right: 20, // Adjust as needed for Language Selector
          ...
          if (_isAuthenticating) // Conditional overlay for loading animation
            Container(
          ...
          Positioned(
            bottom: 35, // Adjust as needed for Smiley Face Thrower
  ...
  void _updatePasswordValidity() {
    ...
    final isValid =
        _validatePassword(password) == null && password == confirmPassword;

    setState(() {
      _isPasswordValid = isValid;
      _initWidgetsAndAnimations2(); // Assuming this is part of your state management
    });
  }
...
//// Helper method to build input decoration with a functional visibility toggle
  ...
  Future<void> _handleSignUp() async {
    if (!_isPasswordValid) {
      await _showSnackBar(
          "Please confirm your password first, choose a strong password");
      return;
    }
